...
const double ComplementaryFilter::kGravity = 9.80;
const double ComplementaryFilter::gamma_ = 0.01;
// Bias estimation steady state thresholds
const double ComplementaryFilter::kAngularVelocityThreshold = 0.2;// kAngularVelocityThreshold * 57.3 deg/s
const double ComplementaryFilter::kAccelerationThreshold = 0.1;
const double ComplementaryFilter::kDeltaAngularVelocityThreshold = 0.002;// kDeltaAngularVelocityThreshold * 57.3 deg/s 
...
ComplementaryFilter::ComplementaryFilter()
    : gain_acc_(0.01),
      ...
      wy_bias_(0),
      wz_bias_(0)
    //   wx_bias_(-0.003137388),
    //   wy_bias_(0.003309258),
    //   wz_bias_(-0.001895346)
{
}
...
void ComplementaryFilter::getOrientation(double& q0, double& q1, double& q2,double& q3)
{
